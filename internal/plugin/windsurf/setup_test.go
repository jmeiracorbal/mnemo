...
func TestEmbeddedTemplates(t *testing.T) {
	t.Run("global_rules.md", func(t *testing.T) {
		data, err := templatesFS.ReadFile("templates/global_rules.md")
		if err != nil {
...
func TestRenderTemplate(t *testing.T) {
	content, err := renderTemplate(templatesFS, "templates/global_rules.md", nil)
	if err != nil {
